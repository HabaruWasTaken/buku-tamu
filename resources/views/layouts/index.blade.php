...
<body class="bg-dark font-montserrat">
    <nav class="flex bg-primary py-[12px] px-[30px] text-light justify-between sticky z-10 w-full top-0">
        ...
        <div class="flex items-center gap-[20px] text-secondary">
            <a href="{{ route('dashboard') }}" class="text-[18px] hover:text-light flex hover:underline underline-offset-[8px] decoration-[2px] items-center transition-all duration-300">Home</a>
            <div class="group/employee flex flex-col relative">
                <a href="{{ route('employee.index') }}" class="text-[18px] group-hover/employee:text-light flex group-hover/employee:underline underline-offset-[8px] decoration-[2px] items-center transition-all duration-300 z-[2]">Employee<x-fas-angle-down class="size-[18px] ml-[2px]"/></a>
            ...
            <div class="group/visit_history flex flex-col relative">
                <a href="{{ route('visit_history.index') }}" class="text-[18px] group-hover/visit_history:text-light flex group-hover/visit_history:underline underline-offset-[8px] decoration-[2px] items-center transition-all duration-300 z-[2]">Visitation<x-fas-angle-down class="size-[18px] ml-[2px]"/></a>
